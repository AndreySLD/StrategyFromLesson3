...
namespace UserControlSystem
{
    public sealed class CommandButtonsModel
    {
        ...
        [Inject] private CommandCreatorBase<ISetDepotPointCommand> _setPoint;
        ...
        public void OnCommandButtonClicked(ICommandExecutor commandExecutor, ICommandsQueue commandsQueue)
        {
            ...
            _setPoint.ProcessCommandExecutor(commandExecutor, command => ExecuteCommandWrapper(command, commandsQueue));
        }
