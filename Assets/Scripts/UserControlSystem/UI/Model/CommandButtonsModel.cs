...
namespace UserControlSystem
{
    public sealed class CommandButtonsModel
    {
        ...
        [Inject] private CommandCreatorBase<IProduceGrenadierCommand> _grenadierProducer;
        [Inject] private CommandCreatorBase<IAttackCommand> _attacker;
        [Inject] private CommandCreatorBase<IStopCommand> _stopper;
        [Inject] private CommandCreatorBase<IMoveCommand> _mover;
        [Inject] private CommandCreatorBase<IPatrolCommand> _patroller;
        [Inject] private CommandCreatorBase<ISetDepotPointCommand> _setDepot;
        ...
        public void OnCommandButtonClicked(ICommandExecutor commandExecutor, ICommandsQueue commandsQueue)
        {
            ...
            _grenadierProducer.ProcessCommandExecutor(commandExecutor, command => ExecuteCommandWrapper(command, commandsQueue));
            ...
            _setDepot.ProcessCommandExecutor(commandExecutor, command => ExecuteCommandWrapper(command, commandsQueue));
        }
        ...
        private void processOnCancel()
        {
            ...
            _setDepot.ProcessCancel();
            _grenadierProducer.ProcessCancel();
